...
This lab provides a comprehensive overview of building, deploying, and securing AI agents. We will start by creating a single agent with Azure Functions and Azure AI Agent Service in Azure AI Foundry, then enhance it with Model Context Protocol (MCP) and add data grounding with Azure Cosmos DB. You will also combine the single agents to form a multi-agent system. You will then deploy, manage and secure the application on a Flex Consumption plan.
